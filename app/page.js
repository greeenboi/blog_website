    ...
    <Head>
      ...
      <main className="flex min-h-screen flex-col items-center justify-between p-24 pt-12 ">
        ...
        <section className='flex flex-row h-max w-full'>
          <p className=' font-normal font-poppins'>Featured</p>
          ...
          <div className='hidden md:flex flex-col scroll-m-1'>
            <p>Recent Posts</p>
            <div className='flex flex-row gap-2 p-6 border border-emerald-600 hover:border-emerald-800 m-2 items-center rounded-md'><img width='128' className='relative border border-teal-500 rounded-sm ' src="https://images.unsplash.com/photo-1541701494587-cb58502866ab?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80" alt="placeholder_post_img"/> <h1 className='absolute ml-2'>Title</h1> <button>view post</button></div>
