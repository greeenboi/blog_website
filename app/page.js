  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col items-center justify-between p-24 pt-12 ">
        <section className="head-container font-sans">
          <h1 className=''>THE BLOG</h1>
        </section>
        <section className='flex flex-row h-max w-full'>
          <div className='grid grid-flow-row items-center justify-center md:grid-flow-col h-fit flex-1 auto-cols-max gap-4 md:gap-6 lg:gap-10'>
